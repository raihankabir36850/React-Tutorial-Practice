  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        {addFriend && (
          <FormAddFriend setAddFriend={setAddFriend} setNewUser={setNewUser} />
        )}

        <div className="button-container">
          <Button onClick={(e) => addFormHandler(e)}>
      ...
      {splitBill && (
        <SplitBillForm
          ...
          splitBillCalculation={splitBillCalculation}
          key={splitBill.id}
        />
      )}
    </div>
...
function Friend({ friend, splitBill, splitBillHandler }) {
  return (
    <li>
      ...
      <Button onClick={() => splitBillHandler(friend)}>
        {splitBill === friend ? "Close" : "Select"}
      </Button>
    </li>
  );
}
  ...
  return (
    <form className="form-split-bill" onSubmit={(e) => splitBillHandler(e)}>
      ...
      <input
        ...
        onChange={(e) =>
          ownMoneyHandler(
            Number(e.target.value) > total ? myMoney : Number(e.target.value)
          )
        }
      />
